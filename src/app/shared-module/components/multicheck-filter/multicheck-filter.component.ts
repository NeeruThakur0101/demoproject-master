...
export class MulticheckFilterComponent implements AfterViewInit {
    ...
    public ngAfterViewInit() {
        ...
        this.showFilter =
            typeof this.textAccessor(this.currentData[0]) === 'string' || typeof this.textAccessor(this.currentData[0]) === 'boolean' || typeof this.textAccessor(this.currentData[0]) === 'number';
    }
